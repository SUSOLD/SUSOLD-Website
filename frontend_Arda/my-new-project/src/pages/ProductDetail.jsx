...
import { addToBasketLocal } from '../utils/basketUtils'; // ✅ Import local basket function
...
const ProductDetail = () => {
  ...
  const handleAddToFavorites = async () => {
    ...
    try {
      const response = await fetch(`http://127.0.0.1:8001/api/favorites/${itemId}`, {
        method: 'POST',
        headers: {
  ...
  const handleAddToBasket = () => {
    addToBasketLocal(itemId);   // ✅ Save locally without login
